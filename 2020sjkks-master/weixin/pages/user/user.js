...
Page({
  ...
  onLoad: function (options) {
    ...
    if(this.data.uphoto != null){
      this.setData({img_src:getApp().globalData.server + '/image/u'+app.globalData.uid+'.jpg'+'?'+this.data.random})
    }else{
      this.setData({img_src:getApp().globalData.server + '/image/user_default.jpg'+'?'+this.data.random})
    }
